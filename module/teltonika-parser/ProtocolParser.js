...
const avlDict_1 = require("./AVL Data Parser/FMB640/avlDict");
...
class ProtocolParser {
    constructor(packet, basic_read = false, on_ioElement_error = (e) => { throw e; }) {
        ...
        var expected_crc = CRC16_1.CalcCRC16(crc_reader.remainingContent());
...
exports.FMB640Utils = {
    ...
    avlidDictionary: avlDict_1.avlidDictionary,
